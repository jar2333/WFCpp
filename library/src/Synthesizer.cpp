...
void Synthesizer::exportGridToFile(const SolverGrid& grid, std::string exportPath, FileType type)
{
...
std::shared_ptr<BMPImage> Synthesizer::exportGridToImage(const SolverGrid& grid)
{
